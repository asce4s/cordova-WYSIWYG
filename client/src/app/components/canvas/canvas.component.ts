...
export class CanvasComponent implements OnInit {
    ...
    constructor(private dragulaService: DragulaService,
                ...
                public _selectedElement: SelectedElementService) {
        ...
        if (key == "button") {
            ...
            this.genElement(value[1], this._elprovider.getButton(),
                ...
                (id) => {
                    ...
                    //this._selectedElement.selectedButton=defaults;
                ...
                (event) => {
                    ...
                    //this._selectedElement.selectedButton = this._buttonService.get(event.toElement.id);
                    this.text = this.selectedButton.script;
    ...
    private toFalse() {
        this._selectedElement.selectedButton = null;
